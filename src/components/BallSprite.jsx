...
export default function BallSprite({ size = 0, rotation = 0, id, showTooltip, tooltipText, animation }) {
  return (
    <div className="w-fit h-fit relative inline-block">
      ...
      {showTooltip && (
        <div className={`absolute -top-8 left-8 mt-2 ml-2 px-2 py-1 bg-black text-white rounded whitespace-nowrap ${animation ? "animate-ping" : ""}`}>
          {tooltipText}
        </div>
      )}
    </div>
