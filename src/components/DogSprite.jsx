...
export default function DogSprite({ width = 50, height = 50, rotation = 0, id, showTooltip, tooltipText, animation }) {
  return (
    <div className="w-fit h-fit relative inline-block">
      <svg
        ...
        style={{ WebkitTransform: "scaleX(-1)", transform: `scaleX(-1) rotate(${rotation}deg)`, transformOrigin: '50% 50%' }}
